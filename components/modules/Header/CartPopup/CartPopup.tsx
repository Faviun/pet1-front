...
import { IWrappedComponentProps } from '@/lib/types/common'
import { withClickOutside } from '@/lib/utils/withClickOutside'
...
import { getCartItemsFx } from '@/lib/api/shopping-cart'
